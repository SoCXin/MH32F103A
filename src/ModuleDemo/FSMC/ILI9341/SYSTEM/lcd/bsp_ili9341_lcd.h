...
/******控制信号线******/
//片选，选择NOR/SRAM块
#define      ILI9341_CS_CLK                RCC_APB2Periph_GPIOD   	//PD7 NE1
#define      ILI9341_CS_PORT               GPIOD
#define      ILI9341_CS_PIN                GPIO_Pin_7

//DC引脚，使用FSMC的地址信号控制，本引脚决定了访问LCD时使用的地址
//PD11为FSMC_A16
#define      ILI9341_DC_CLK                RCC_APB2Periph_GPIOD   //PD11 A16
#define      ILI9341_DC_PORT               GPIOD
#define      ILI9341_DC_PIN                GPIO_Pin_11

//写使能
#define      ILI9341_WR_CLK                RCC_APB2Periph_GPIOD   //NWE PD5
#define      ILI9341_WR_PORT               GPIOD
#define      ILI9341_WR_PIN                GPIO_Pin_5//NWE

//读使能
#define      ILI9341_RD_CLK                RCC_APB2Periph_GPIOD   //NOE PD4
#define      ILI9341_RD_PORT               GPIOD
#define      ILI9341_RD_PIN                GPIO_Pin_4//NOE

//复位引脚
#define      ILI9341_RST_CLK               RCC_APB2Periph_GPIOD   //PD6
#define      ILI9341_RST_PORT              GPIOD
#define      ILI9341_RST_PIN               GPIO_Pin_6

//背光引脚
#define      ILI9341_BK_CLK                RCC_APB2Periph_GPIOD  //PD3
