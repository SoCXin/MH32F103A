...
@code  
 ...
 This driver provides functions to configure and program the Flash memory of all MH32F10x devices,
 including the latest MH32F10x_XL density devices. 

 MH32F10x_XL devices feature up to 1 Mbyte with dual bank architecture for read-while-write (RWW) capability:
    - bank1: fixed size of 512 Kbytes (256 pages of 2Kbytes each)
    - bank2: up to 512 Kbytes (up to 256 pages of 2Kbytes each)
 While other MH32F10x devices features only one bank with memory up to 512 Kbytes.

 In version V3.3.0, some functions were updated and new ones were added to support
 MH32F10x_XL devices. Thus some functions manages all devices, while other are 
 dedicated for XL devices only.
 
 The table below presents the list of available functions depending on the used MH32F10x devices.  
      
   ***************************************************
   * Legacy functions used for all MH32F10x devices *
   ***************************************************
   +----------------------------------------------------------------------------------------------------------------------------------+
   |       Functions prototypes         |MH32F10x_XL|Other MH32F10x|    Comments                                                    |
   |                                    |   devices  |  devices      |                                                                |
   |----------------------------------------------------------------------------------------------------------------------------------|
   ...
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_Unlock                        |    Yes     |      Yes      | - For MH32F10X_XL devices: unlock Bank1 and Bank2.            |
   |                                    |            |               | - For other devices: unlock Bank1 and it is equivalent         |
   |                                    |            |               |   to FLASH_UnlockBank1 function.                               |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_Lock                          |    Yes     |      Yes      | - For MH32F10X_XL devices: lock Bank1 and Bank2.              |
   |                                    |            |               | - For other devices: lock Bank1 and it is equivalent           |
   |                                    |            |               |   to FLASH_LockBank1 function.                                 |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ErasePage                     |    Yes     |      Yes      | - For MH32F10X_XL devices: erase a page in Bank1 and Bank2    |
   |                                    |            |               | - For other devices: erase a page in Bank1                     |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_EraseAllPages                 |    Yes     |      Yes      | - For MH32F10X_XL devices: erase all pages in Bank1 and Bank2 |
   ...
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ITConfig                      |    Yes     |      Yes      | - For MH32F10X_XL devices: enable Bank1 and Bank2's interrupts|
   |                                    |            |               | - For other devices: enable Bank1's interrupts                 |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_GetFlagStatus                 |    Yes     |      Yes      | - For MH32F10X_XL devices: return Bank1 and Bank2's flag status|
   |                                    |            |               | - For other devices: return Bank1's flag status                |
   |----------------------------------------------------------------------------------------------------------------------------------|
   |FLASH_ClearFlag                     |    Yes     |      Yes      | - For MH32F10X_XL devices: clear Bank1 and Bank2's flag       |
   ...
   ************************************************************************************************************************
   * New functions used for all MH32F10x devices to manage Bank1:                                                        *
   *   - These functions are mainly useful for MH32F10X_XL density devices, to have separate control for Bank1 and bank2 *
   ...
   *****************************************************************************
   * New Functions used only with MH32F10X_XL density devices to manage Bank2 *
   *****************************************************************************
   +----------------------------------------------------------------------------------------------------------------------------------+
   |       Functions prototypes         |MH32F10X_XL|Other MH32F10x|    Comments                                                    |
   |                                    |   devices  |  devices      |                                                                |
...
/**
  ...
  * @note   This function can be used for all MH32F10X_XL devices.
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices this function unlocks Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices this function unlocks Bank1.
...
/**
  ...
  * @note   This function can be used only for MH32F10X_XL density devices.
  * @param  None
  * @retval None
  */
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices this function Locks Bank1 and Bank2.
...
/**
  ...
  * @note   this function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices this function Locks Bank1.
  *         - For all other devices it Locks Bank1 and it is equivalent 
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices this function erases all Bank1 pages.
...
/**
  ...
  *     @arg For @b MH32_Low-density_devices: value between FLASH_WRProt_Pages0to3 and FLASH_WRProt_Pages28to31  
  *     @arg For @b MH32_Medium-density_devices: value between FLASH_WRProt_Pages0to3
  *       and FLASH_WRProt_Pages124to127
  *     @arg For @b MM32_High-density_devices: value between FLASH_WRProt_Pages0to1 and
  *       FLASH_WRProt_Pages60to61 or FLASH_WRProt_Pages62to255
  *     @arg For @b MH32_Connectivity_line_devices: value between FLASH_WRProt_Pages0to1 and
  *       FLASH_WRProt_Pages60to61 or FLASH_WRProt_Pages62to127    
  *     @arg For @b MH32_XL-density_devices: value between FLASH_WRProt_Pages0to1 and
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices, enables or disables the specified FLASH interrupts
              for Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices, this function checks whether the specified 
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices.
  *         - For MH32F10X_XL devices, this function clears Bank1 or Bank2’s pending flags
...
/**
  ...
  * @note   This function can be used for all MH32F10x devices, it is equivalent
...
/**
  ...
  * @note   This function can be used for MH32F10x_XL density devices.
  * @param  None
  * @retval FLASH Status: The returned value can be: FLASH_BUSY, FLASH_ERROR_PG,
  *        FLASH_ERROR_WRP or FLASH_COMPLETE
  */
...
/**
  ...
  *         - For MH32F10X_XL devices this function waits for a Bank1 Flash operation
